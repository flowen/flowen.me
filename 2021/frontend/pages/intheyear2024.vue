  ...
  <client-only>
    <section class="project-page">
      ...
      <p class="project-page__description">
        ...
        domain for $1 per share with a 100 shares per URL. This is just one of the many crazy
        concepts MSCHF creates and I was honored to build it for them this time.<br />

<template>
  <section class="project-page">
    ...
    <div class="project-page__project-url">
      ...
      <a href="https://fauxmegle.com" target="_blank" rel="noopener noreferrer">
        Open the live website
      </a>
    </div>

    <p class="project-page__description">
      In the universe of the modern internet, the shitty metaverse in which we live our lives, clout
      is the equivalent of a natural resource. It is both commodity and currency. By this same
      token, celebrities function like mines or natural mineral deposits: they are sources of clout
      that can be tapped via proximity. As a guy* on the internet once said: move content from one
      platform to another; get famous. Celebrity encounters are pseudo-chance occurrences that can
      (and must!) be leveraged. When we encounter a celebrity we are compelled to post video or
      screenshots of the encounter far and wide, to shout at the top of our lungs that fame has
    ...
    <dl class="project-page__summary">
      <dd>For:</dd>
      <dt>
        <a href="https://mschf.com/fauxmegle" target="_blank" rel="noopener noreferrer">MSCHF</a>
      </dt>
      <dd>Created:</dd>
